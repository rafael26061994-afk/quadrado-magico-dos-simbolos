...
// ALTERNAR A ORDEM DAS FOTOS DE FORMA ALEATÓRIA
function randomizeMagicians() {
    ...
    // Lista contendo os caminhos exatos das fotos em formato .jpg
    const magicians = [
...
// SINTETIZADOR DE VOZ (LEITURA EM ÁUDIO)
function readText() {
    stopSpeech();
    const activeScreen = document.querySelector('.screen:not(.hidden)');
    
    // Evita ler os códigos e números da tabela para não confundir o usuário
    let textToRead = "";
...
// Executa a ordenação inicial assim que o script carregar
randomizeMagicians();